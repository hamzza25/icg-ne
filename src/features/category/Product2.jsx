...
function Product2() {
    return (
        <div>
            <div
                className="relative rounded-xl mt-12 m-auto w-11/12 h-[419px] bg-repeat bg-cover bg-bottom"
            ...
            >
                ...
                <div className="absolute inset-0 flex justify-center items-center">
                    <h3 className="text-4xl text-white">OMNIQUAN 292</h3>
                </div>
            </div>
            ...
            <div className="px-20 pt-8 leading-loose">
                <div className="pt-8 pb-6">
                    <h3 className="text-2xl font-semibold text-[#023B3B]">About OMNIQUAN 292 – CAS <span className="font-normal">129757-67-1</span></h3>
